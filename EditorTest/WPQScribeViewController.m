#import "WPQScribeViewController.h"
#import "WPKeyboardToolbarBase.h"
#import "WPQUtilities.h"

@interface WPQScribeViewController() <UIWebViewDelegate, WPKeyboardToolbarDelegate>
...
@implementation WPQScribeViewController
...
{
    [MMStopwatchARC stop:@"Scribe Init"];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if([[[request URL] absoluteString] isEqualToString:@"app://api-triggered-text-change"]) {
        [MMStopwatchARC stop:@"Scribe Load"];
        return false;
    }
    return true;
}
...
- (IBAction)didPressShortContent:(id)sender
{
    if (_didFinishLoadingEditor) {
        ...
        [MMStopwatchARC start:@"Scribe Load"];
